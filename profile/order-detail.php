                ...
                <span class="hs-nav-scroller-arrow-prev" style="display: none;">
                  ...
                  <a class="hs-nav-scroller-arrow-link" href="javascript:;">
                    <i class="bi-chevron-right"></i>
                            ...
                            <?php if (!empty($orders)):?>
                                ...
                                <table class="table">
                                    ...
                                    <?php $i = 1; foreach ($orders as $order): ?>
                                        <?=  $total += $order['priceEach'] * $order['quantity'];?>
                                        <tr>
                                            <td><?= $i++;?></td>
                                            <td><img src="../<?=$order['image'];?>" alt="" width="100"></td>
                                            <td><?= isset($order['name']) ? $order['name'] : '' ?></td>
                                            <td><?= isset($order['quantity']) ? $order['quantity'] : '' ?></td>
                                            <td>$<?= isset($order['priceEach']) ? $order['priceEach'] : '<span class="badge bg-warning">Yetkazilmagan</span>' ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
                                </table>
                            ...
                            <dl class="row">
                                <dt class="col-sm-6">Umumiy narxi</dt>
                                <dd class="col-sm-8">$<span class="total"> <?= $total ?></span></dd>
                            </dl>
                            <a href="orders.php" class="btn btn-primary d-block">Orqaga</a>
